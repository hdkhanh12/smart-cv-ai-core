...
class SearchQueryFilters(ContractModel):
    ...
    skills: list[str] | None = Field(default=None, alias="Skills", description="Kỹ năng bắt buộc (Must-have skills)")
    job_titles: list[str] | None = Field(default=None, alias="JobTitles", description="Chức danh công việc tìm kiếm")
    companies: list[str] | None = Field(default=None, alias="Companies", description="Công ty mục tiêu hoặc công ty đăng tuyển")
    languages: list[str] | None = Field(default=None, alias="Languages", description="Yêu cầu ngoại ngữ (Tiếng Anh, Tiếng Nhật...)")
    highest_education: str | None = Field(default=None, alias="HighestEducation", description="Trình độ học vấn cao nhất")
    work_type: str | None = Field(default=None, alias="WorkType", description="Hình thức làm việc (Remote | Onsite | Hybrid)")
